    ...
    >
      ...
      <div style={{ position: 'absolute', top: 0, left: 0, right: 0, lineHeight: 0 }}>
        <svg viewBox="0 0 1440 60" preserveAspectRatio="none" style={{ width: '100%', height: '60px', display: 'block' }}>
          <path d="M0,20 C360,60 1080,-20 1440,20 L1440,0 L0,0 Z" fill="#0a0a0f" />
        </svg>
      </div>
      ...
      <div style={{ position: 'absolute', inset: 0, pointerEvents: 'none', overflow: 'hidden' }}>
        <div style={{
          ...
          borderRadius: '50%', bottom: '-200px', left: '-150px',
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '0 2rem', textAlign: 'center', position: 'relative', zIndex: 1 }}>
        ...
        <div className="contact-body">
          ...
          <a
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow = '0 0 55px rgba(108,99,255,0.6)';
        ...
        {/* Divider */}
        <div style={{
          width: '1px', height: '60px', background: 'rgba(108,99,255,0.2)',
          margin: '0 auto 2.5rem',
        }} />
